...
$autorespondTemplate = "Bonjour {name},<br><br>Merci pour votre message. Nous reviendrons vers vous très prochainement.<br>Voici les informations que vous nous avez transmises:<br><br>{formdata}<br><br>---<br>En vous souhaitant une agréable journée.<br>@muutesessions";					// Autorespond Template
